...
<form data-bitwarden-watching="1" onSubmit={validateForm}>
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" readonly={false} class="form-control" id="login" minLength={5} maxLength={20} defaultValue="" placeholder="your-login" onInput={e => setCredentials({...credentials, login: e.currentTarget.value})} onFocus={() => setErrorMessage("")} required></input>
				<small class="form-text text-muted">Your user login should be at least 5 characters long but not longer than 20 characters.</small>
      </div>
			</label>
    </div>
		<div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="password" minLength={5} maxLength={20} readonly={false} class="form-control" id="password" placeholder="your-password" onInput={e => setCredentials({...credentials, password: e.currentTarget.value})} onFocus={() => setErrorMessage("")} required/>
				<small class="form-text text-muted">Your user password should be at least 5 characters long but not longer than 20 characters.</small>
      </div>
			</label>
    </div>
		</fieldset>
