	 ...
	 return (
			<Layout title="Roomoney 💰 - Create house">
			 ...
			 <h1 class="text-success">Create a new virtual household here</h1>
				 <p>
					<p class="text-secondary">When a household is created, you will see a household secret code. Copy it and share with someone to join you. If you don't copy the code now, you can find it in Dashboard/Manage households </p>
				 </p>
				 </div>
				 <CreateHouseForm />
